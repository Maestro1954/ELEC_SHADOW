...
from tkinter import messagebox #Waninig message 
...
#	mainWindow.quit()
	##already commented out # Add sys.exit(0) here to close window on Raspberry Pi
...
buttonX = tk.Button(mainWindow, text="Exit", command=warningMessage)
