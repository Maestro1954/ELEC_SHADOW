...
def multiFrameCapture(event = 0):
    ...
    if timerArmed:
        ...
        time_display.place(bordermode=tk.INSIDE, relx=0.85, y=45, rely=0.6, anchor=tk.CENTER, width=120, height=30) # 00:00
...
def timerWindow(event=0):
    global cancel, timeText, time_display, frame_display
    cancel = False
